...
table.credits thead { background:transparent; }
  ...
  and perform an additive blending pass for each interactions. A process that I described in my <a href="https://fabiensanglard.net/doom3/renderer.php">first series of articles</a> about Doom3 engine.<br/>
  <br/>
...
The previous renderer featured <a href="https://fabiensanglard.net/doom3/fb_design_renderer.png">many rendering path</a>: One for
