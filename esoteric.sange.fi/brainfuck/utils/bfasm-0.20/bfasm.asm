...
; Note: (!!!) means that this value might need to be changed if the data lists change.
stk     1
org     20      ; (!!!)
db_     171
db_     177
...
lbl 9                           ;   m9:
        ...
        ne_     r2,3
        jnz     r2,11
        mov     r2,."           ;     if (m[0] != '\"') goto m12 (syntax error, open quote expected)
        ne_     r2,r1
        jnz     r2,12
        mov     r2,1            ;     m[1] = 4
        sto     r2,4
...
lbl 5                           ; m5:
        clr     r2              ;   m[0] = r1
        sto     r2,r1
        rcl     r1,4            ;   if (m[4] && m[4] == m[5]) {   0.20
        jz_     r1,54
        rcl     r2,5
        ne_     r1,r2
        jnz     r1,54
        mov     r1,6            ;     m[6] = 22                   0.20
        sto     r1,22
        mov     r1,5            ;     m[5] = 'j'                  0.20
        sto     r1,.j
        psh     55              ;     outbf() (mov)               0.20
        jmp     100
lbl 55
        rcl     r1,4            ;     m[5] = m[4]                 0.20
        mov     r2,5
        sto     r2,r1
        dec     r2              ;     m[4] = 'j'                  0.20
        sto     r2,.j
